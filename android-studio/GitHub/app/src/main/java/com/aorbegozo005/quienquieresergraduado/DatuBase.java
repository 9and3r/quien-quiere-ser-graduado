...
public class DatuBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO \"main\".\"Pregunta\" (\"galdera\",\"erantzuna_zuzena\",\"erantzuna_1\",\"erantzuna_2\",\"erantzuna_3\",\"bloke\") VALUES ('¿A la hora de diseñar la interfaz de un Sistema de Iteracción, qué elemento ayuda a la percepción de la profundidad?','Scroll','Cliquear','Arrastrar','Touchpad',4)");
        db.execSQL("INSERT INTO \"main\".\"Pregunta\" (\"galdera\",\"erantzuna_zuzena\",\"erantzuna_1\",\"erantzuna_2\",\"erantzuna_3\",\"bloke\") VALUES ('¿Qué tiene una PLC?','Entradas y salidas','Sólo entradas','Sólo salidasr','Tiene swag',4)");
